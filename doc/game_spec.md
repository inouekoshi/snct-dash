...
| 2 | 電気電子工学科 | 7.5 | 回路・コイル・コンデンサ（ジャンプ→スライド） | 回路基板グリッド |
| 3 | 電子情報工学科 | 10.5 | バグ・モニター・チップ（上下ホップ） | マトリックス数字 |
| 4 | 生物応用化学科 | 13.5 | 細菌・フラスコ・キノコ（ゆらゆら・密集） | 浮遊気泡 |
| 5 | 材料工学科 | 17 | クリスタル・インゴット・格子（高密度） | 結晶格子 |
